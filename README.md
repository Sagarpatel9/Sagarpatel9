...
**Stack:** Microsoft Azure · Windows Server 2025 · AD DS · DNS · GPO · PowerShell

Built an enterprise AD environment on Azure with a Domain Controller, domain-joined client, and 51 users across 4 department OUs. Configured 5 Group Policies including password/lockout enforcement, desktop lockdown with IT exceptions, USB restriction, and wallpaper policy. Documented 10 real-world helpdesk scenarios with step-by-step SOPs covering password resets, account lockouts, user onboarding, GPO troubleshooting, bulk password resets, and trust relationship repair.

[View project →](https://github.com/Sagarpatel9/Active-Directory-Lab)
